...
A felhasználói felület vázát Adobe XD\footnote{\url{https://www.adobe.com/products/xd.html} (utolsó elérés: 2021.05.12)}-ben terveztem meg. Négy fő oldallal foglalkoztam, melyek a legfontosabbak az alkalmazás napi használatában. Az oldal tetején található navigációs sávval lehet váltani a különböző oldalak között.

A vállalkozók között böngésző oldalon megtalálható az összes regisztrált vállalkozó. Egy vállalkozóhoz hozzátartozik a profilképe, neve, foglalkozása és rövid leírása. Egy vállalkozó nevére kattintva juthatunk el a vállalkozó oldalára.

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=1.0\textwidth]{wireframes/contractors}}
	\caption{Vállalkozó böngésző oldal terve}
\end{figure}

\clearpage

Egy vállalkozó oldalán megtalálhatók az ő adatai és a szabad időpontjai. Az időpontokat lehet kategória és kezdő dátum szerint szűrni. Egy időpontnál megtalálhatók az adatai és a foglalás gomb.

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=1.0\textwidth]{wireframes/contractor}}
	\caption{Egy vállalkozó oldalának terve}
\end{figure}

A vállalkozói oldalon a vállalkozó az időpontjait és kategóriáit meg tudja tekinteni, szerkeszteni és az időpontokat törölni.

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=1.0\textwidth]{wireframes/own_appointments}}
	\caption{Vállalkozói oldal terve}
\end{figure}

A számlázási oldalon a vállalkozó ki tud választani egy ügyfelet, akinek a foglalt időpontjait láthatja egy táblázatban összesítve. Ezt tudja szűrni dátum alapján, továbbá PDF-et generálni ebből.

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=1.0\textwidth]{wireframes/report}}
	\caption{Számlázási oldal terve}
\end{figure}

A felhasználói felületen használtam ingyenes felhasználású SVG ikonokat, melyeket Freepik\footnote{\url{https://www.flaticon.com/authors/freepik} (utolsó elérés: 2021.05.12)} készített.
...
Ez az egyből egymás után 500 lekérdezés bőven túllövi azt, amire ez az alkalmazás tervezve lett, hogy pár vállalkozó naponta egyszer kétszer pár időpontot hirdet, meg minden időpontot lefoglal egy pár ügyfél. Viszont, mint az adatból látható, így is elég gyorsan végrehajtotta ezeket az alkalmazás, valós keretek között is hasonlóan gyors végrehajtásra lehet számítani.
